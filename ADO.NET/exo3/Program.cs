...
class Program
{
    static void Main()
    {
        ...
        List<string> selectQueryString = new List<string>
        {
            "SELECT model FROM Car WHERE id > 2;",
            "SELECT AVG(price) AS AveragePrice FROM Car;"
        };
        ...
        { 
            ...
            foreach (string selectQuery in selectQueryString)
            { 
